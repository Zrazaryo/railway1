...
try {
    ...
    // Handle STATUS_ONLY case - skip this file and try to find another one
    if ($file['file_path'] === 'STATUS_ONLY') {
        // Try to find another file for this document
    ...
    // Cek apakah mode download (dari download.php)
    ...
    if ($is_image && !$download_mode) {
        ...
        // Mode download atau file non-image
        if ($extension === 'pdf') {
